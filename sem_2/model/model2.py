...
class PhotoionizationModel:
    ...
    def calc_tau_0(self, r_index):
        tau_0 = integrate_from_points(1 - self.alpha_array[-1, :r_index], self.r_array[:r_index])
    ...
    def calc_j_v(self, tau_0,  r_index):
        ...
        res = self.calc_j_nu_0() * self.calc_J(tau_0=tau_0) / self.r_array[r_index] / self.r_array[r_index]
