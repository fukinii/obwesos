...
# path = "/home/ilya/obwesos/sem_2/output0.pickle"
...
model.initialize(alpha_init=alpha_init, T_e_init=T_e_init, T_init=T_init, is_array=False)
...
init_step = 1e-13
tol = 1e-5
model.solve(t0=0., time_max=t_max, init_step=init_step, tolerance=tol, dump_file=False)
